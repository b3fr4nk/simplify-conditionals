...
iris_to_eye_ratio = (math.pi*iris_width/2*iris_height/2) / eye_size
eye_width_to_height = eye_height/eye_width

if eye_size > 0.45 and iris_to_eye_ratio >= 0.69 \
        and eye_width_to_height >= 0.59:
